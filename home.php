...
<html>
  <head>
    ...
    <style>
      ...
      .content {padding: 5px; }
      .card {background-color: white; box-shadow: 0px 0px 10px 1px rgba(140,140,140,.5); border: 1px solid green; border-radius: 15px;}
      .card.header {background-color: green; color: white; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; border-top-right-radius: 12px; border-top-left-radius: 12px;}
      .cards {max-width: 700px; margin: 0 auto; display: grid; grid-gap: 2rem; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));}
      .reading {font-size: 1.3rem;}
      .packet {color: DarkGreen;}
      .temperatureColor {color: orange;}
      .humidityColor {color: blue;}
      .statusreadColor {color: black; font-size:12px;}
