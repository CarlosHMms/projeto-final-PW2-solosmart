...
<body>
  ...
  <script>
      ...
      xmlhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
          ...
          if (myObj.id == "esp32_01") {
            ...
            document.getElementById("ESP32_01_TogLED_01").checked = myObj.LED_01 == "ON";
            document.getElementById("ESP32_01_TogLED_02").checked = myObj.LED_02 == "ON";
          }
        }
      };
    ...
    function GetTogBtnLEDState(togbtnid) {
      ...
      var lednum = togbtnid === "ESP32_01_TogLED_01" ? "LED_01" : "LED_02";
      Update_LEDs("esp32_01", lednum, togbtncheckedsend);
    }
