...
<body class="h-screen content-center items-center justify-items-center" style="background-color:#F5F8DE">
    <aside class="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-[#6D4C3D] transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
        <div>
            <div class="-mx-6 px-6 py-4">
                <a href="<?php echo e(route('home')); ?>" title="home">
                    <img src="<?php echo e(asset('img/logo.png')); ?>" class="w-40" alt="POC WCS">
                </a>
            </div>
            <ul class="space-y-2 tracking-wide mt-8">
                ...
                <li>
                    <a href="<?php echo e(route('home')); ?>" aria-label="dashboard" class="px-4 py-3 flex items-center space-x-4 rounded-md text-white group">
                ...
                <li>
                    <a href="<?php echo e(route('perfil')); ?>" class="px-4 py-3 flex items-center space-x-4 rounded-md text-white group border ">
                ...
                <li>
                    <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md text-white group active:bg-blue">
        ...
        <div class="px-6 -mx-6 pt-4 flex justify-between items-center border-t">
            <a href="<?php echo e(route('login')); ?>" class="px-4 py-3 flex items-center space-x-4 rounded-md text-white group">
    ...
    <div class="content-center flex flex-col items-center justify-items-center w-full">
        <div class="container w-[80%] md:w-[40%] text-gary-950 font-semibold mx-8 flex flex-col justify-center items-center bg-[#F5F8DE] rounded-lg font-sans border border-black shadow-md shadow-black">
            ...
            <div>
                <figure>
                    <img src="<?php echo e(asset('img/profile.png')); ?>" alt="">
                </figure>
            </div>
            <div class="mb-5 mt-5">
