...
<div class="w-full h-[70px] bg-[#6D4C3D] flex items-center">
  <span class="ml-4 cursor-pointer">
    <svg class="h-10 w-10 fill-[#ffff]" id="btnAbrir" viewBox="0 0 32 32" version="1.1"
  ...
  <h3 style="color: green; font-size: 1.8rem;">TABELA DE GRAVAÇÃO - ESP32_01 </h3>

  <aside id="menu"
    class="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-[#6D4C3D] transition duration-300 md:w-4/12 lg:ml-0 lg:w-[250px] xl:w-[250px] 2xl:w-[250px]">
    <div>
      <span class="absolute right-0 cursor-pointer">
        <svg class="h-6 w-6 fill-[#ffff] mr-4 mt-2" id="btnFechar" version="1.1" id="Capa_1"
          xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 47.971 47.971"
          xml:space="preserve">
          <g>
      ...
      <ul class="space-y-2 tracking-wide mt-8">
        <li class="group">
          <a href="{{ route('home')}}" aria-label="dashboard"
            class="px-4 py-3 flex items-center space-x-4 rounded-md text-white group group-hover:border">
            <svg class="h-6 w-6 fill-white group-hover:fill-slate-300" viewBox="-1.5 0 19 19"
        ...
        <li class="group">
          <a href="{{ route('perfil')}}"
            class="px-4 py-3 flex items-center space-x-4 rounded-md text-white group group-hover:border">
            <svg class="h-6 w-6 fill-white group-hover:fill-slate-300" viewBox="-3 0 19 19"
              xmlns="http://www.w3.org/2000/svg" class="cf-icon-svg">
              <path
        ...
        <li class="group">
          <a href="{{route('tables')}}"
            class="px-4 py-3 flex items-center space-x-4 rounded-md text-white group group-hover:border">
            <svg class="h-6 w-6 fill-white group-hover:fill-slate-300" viewBox="-3.5 0 19 19"
              xmlns="http://www.w3.org/2000/svg" class="cf-icon-svg">
              <path
        ...
        <li class="group">
          <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md text-white group group-hover:border">
            <svg class="h-6 w-6 fill-white group-hover:fill-slate-300" viewBox="-1.7 0 20.4 20.4"
              xmlns="http://www.w3.org/2000/svg" class="cf-icon-svg">
              <path
        ...
        <li class="group">
          <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md text-white group group-hover:border">
            <svg class="h-6 w-6 fill-white group-hover:fill-slate-300" viewBox="-1 0 19 19"
              xmlns="http://www.w3.org/2000/svg" class="cf-icon-svg">
              <path
    ...
    <div class="px-6 -mx-6 pt-4 flex justify-between items-center border-t">
      <a href="{{ route('login')}}" class="px-4 py-3 flex items-center space-x-4 rounded-md text-white group">
        <svg class="h-6 w-6 group-hover:text-slate-300" width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
